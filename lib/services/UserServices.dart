...
class UserServices {
  Future<ApiResponse> details(String userId) async {
    ...
    Uri url = Uri.parse('http://41.89.99.58800/userdetails');
    try {
  ...
  Future<ApiResponse> login(String userName, String userPass) async {
    ApiResponse _apiResponse = new ApiResponse();
    Uri url = Uri.parse('http://41.89.99.5:8800/login');
  ...
  Future<ApiResponse> signup(
    ...
    int isAdmin = 0;
    ApiResponse _apiResponse = new ApiResponse();
    Uri url = Uri.parse('http://41.89.99.5:8800/login/newuser');
    try {
      final http.Response response = await http.post(
        url,
        headers: <String, String>{
...
//    int isAvailable= 0;
    ...
    Uri url = Uri.parse('http://41.89.99.5:8800/');
    try {
